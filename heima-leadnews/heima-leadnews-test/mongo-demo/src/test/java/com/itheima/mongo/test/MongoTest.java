...
public class MongoTest {
    ...
    public void saveFindOne(){
        ApAssociateWords apAssociateWords = mongoTemplate.findById("631aada906df894673f5060c", ApAssociateWords.class);
    ...
    public void testQuery(){
        Query query = Query.query(Criteria.where("associateWords").regex(".*?\\"+"你是"+".*"))
